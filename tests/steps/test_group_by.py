...
class TestGroupBy:
    ...
    async def test_group_by_simple_key(self):
        ...
        pipeline = r.group_by(lambda x: x % 2)
    ...
    async def test_group_by_first_letter(self):
        ...
        pipeline = r.group_by(lambda word: word[0].upper())
        result = await (["apple", "banana", "cherry", "apricot", "blueberry"] | pipeline).collect()
    ...
    async def test_group_by_empty_input(self):
        ...
        pipeline = r.group_by(lambda x: x)
    ...
    async def test_group_by_all_same_key(self):
        ...
        pipeline = r.group_by(lambda x: "same")
    ...
    async def test_group_by_complex_objects(self):
        ...
        pipeline = r.group_by(lambda person: person["department"])
    ...
    async def test_group_by_with_duplicates(self):
        ...
        pipeline = r.group_by(lambda x: x % 3)
